...
#ifndef YY_YY_SRC_INCLUDE_Y_TAB_H_INCLUDED
# define YY_YY_SRC_INCLUDE_Y_TAB_H_INCLUDED
...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    union union_type
    {
      ...
      // tok_f16
      // basic_type
      char dummy1[sizeof (Type::BasicType)];
      ...
      // expr
      char dummy4[sizeof (unique_ptr<ExprAST>)];

      // function_call
      char dummy5[sizeof (unique_ptr<FunctionCallAST>)];
      ...
      // stmt
      char dummy8[sizeof (unique_ptr<StmtAST>)];

      // term
      char dummy9[sizeof (unique_ptr<TermAST>)];
      ...
      // stmts
      char dummy14[sizeof (vector<unique_ptr<StmtAST>>)];

      // variable_decs
      char dummy15[sizeof (vector<unique_ptr<VarDecAST>>)];
    };
...
#endif
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, Type::BasicType&& v)
        : Base (t)
        , value (std::move (v))
      {}
#else
      basic_symbol (typename Base::kind_type t, const Type::BasicType& v)
        : Base (t)
        , value (v)
      {}
#endif
...
switch (yytype)
    {
      ...
      case 12: // tok_f16
      case 32: // basic_type
        value.template destroy< Type::BasicType > ();
        break;
    ...
    struct symbol_type : basic_symbol<by_type>
    {
      ...
      {
        YY_ASSERT (tok == 0 || tok == token::tok_arrow || tok == 59 || tok == 61 || tok == 123 || tok == 125 || tok == 58 || tok == 44 || tok == 40 || tok == 41 || tok == 43 || tok == 45);
      }
#else
      symbol_type (int tok)
        : super_type(token_type (tok))
...
#endif
#if 201103L <= YY_CPLUSPLUS
      symbol_type (int tok, Type::BasicType v)
        : super_type(token_type (tok), std::move (v))
      {
        YY_ASSERT (tok == token::tok_i128 || tok == token::tok_i64 || tok == token::tok_i32 || tok == token::tok_i16 || tok == token::tok_f128 || tok == token::tok_f64 || tok == token::tok_f32 || tok == token::tok_f16);
      }
#else
      symbol_type (int tok, const Type::BasicType& v)
    ...
    // Implementation of make_symbol for each symbol type.
      ...
      static
      symbol_type
      make_tok_identifier (const string& v)
      {
      ...
      static
      symbol_type
      make_tok_i128 (Type::BasicType v)
      {
      ...
      static
      symbol_type
      make_tok_i128 (const Type::BasicType& v)
      {
      ...
      static
      symbol_type
      make_tok_i64 (const Type::BasicType& v)
      {
      ...
      static
      symbol_type
      make_tok_i32 (const Type::BasicType& v)
      {
      ...
      static
      symbol_type
      make_tok_i16 (const Type::BasicType& v)
      {
      ...
      static
      symbol_type
      make_tok_f128 (Type::BasicType v)
      {
      ...
      static
      symbol_type
      make_tok_f128 (const Type::BasicType& v)
      {
      ...
      static
      symbol_type
      make_tok_f64 (const Type::BasicType& v)
      {
      ...
      static
      symbol_type
      make_tok_f32 (const Type::BasicType& v)
      {
      ...
      static
      symbol_type
      make_tok_f16 (const Type::BasicType& v)
      {
...
#line 1405 "src/include/y.tab.h"





#endif // !YY_YY_SRC_INCLUDE_Y_TAB_H_INCLUDED
